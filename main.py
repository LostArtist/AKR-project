...
def startclient():
    ...
    while True:
        ...
        while len(data) < msg_size:
            data += client_socket.recv(4096)  # získání šifrovaných dat od klienta
        frame_data = data[:msg_size]  # rozdělení dat do segmentů různých velikostí
        frame_data = fernet.decrypt(frame_data)  # dešifrování získaných dat
        data = data[msg_size:]
